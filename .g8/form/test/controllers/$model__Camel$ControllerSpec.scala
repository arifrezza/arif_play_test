...
class $model;format="Camel"$ControllerSpec extends PlaySpec with GuiceOneAppPerTest with Injecting {
  ...
  "$model;format="Camel"$Controller GET" should {
    ...
    "render the homepagehomepage page from a new instance of controller" in {
    ...
    "render the homepagehomepage page from the application" in {
    ...
    "render the homepagehomepage page from the router" in {
